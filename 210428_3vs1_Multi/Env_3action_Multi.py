...
class Gazebo_Env():
    def __init__(self, n_agents, n_targets, n_laser):
        ...
        self.time_constrain = 2000.0 * self.n_agents
    ...
    def step(self, action):
        ...
        if (self.target_manuver == 1):
            ...
            if (self.map == 1):
                ...
                masked = np.zeros((self.n_targets, self.total_drone))
        ...
        for i in range(self.n_agents):
            self.input_list[i].data = self.state[i].tolist()
    ...
    def get_reward(self):
        ...
        if (self.reward_type == 1): # Sparse Reward
            ...
            for i in range(self.n_agents):
                if (self.collision_done[i] == 1 or self.out_field_done[i] == 1):
                    reward[i] = -3
